...
public class CharacterManagerTests
{
    ...
    [Test]
    public async Task GetTemplate_TemplateDoesNotExist_ThrowsKeyNotFoundException()
    {
        // Arrange
        var manager = CreateCharacterManager();
        var templates = new Dictionary<byte, CharacterTemplate>();
    ...
    [Test]
    public async Task GetExpands_StepDoesNotExist_ThrowsKeyNotFoundException()
    {
        // Arrange
        var manager = CreateCharacterManager();
    ...
    [Test]
    public async Task GetActability_ActabilityDoesNotExist_ThrowsKeyNotFoundException()
    {
        // Arrange
        var manager = CreateCharacterManager();
    ...
    public async Task GetExpertLimit_StepExists_ReturnsExpertLimit()
    {
        ...
        await Assert.That(result.ExpertLimitCount).IsEqualTo(2);
    }
    ...
    public async Task GetExpandExpertLimit_StepExists_ReturnsExpandExpertLimit()
    {
        ...
        // Assert
        await Assert.That(result).IsNotNull();
        await Assert.That(result.ExpandCount).IsEqualTo(1);
    ...
    [Test]
    public async Task PlayerRoll_ValidMax_SendsRollMessage()
    {
        // Arrange
        var manager = CreateCharacterManager();
        var character = new Character(new UnitCustomModelParams())
    ...
    [Test]
    public async Task PlayerRoll_MaxValueOne_SendsRollOne()
    {
        // Arrange
        var manager = CreateCharacterManager();
        var character = new Character(new UnitCustomModelParams())
    ...
    [Test]
    public async Task GetTemplate_MaxByteValues_ThrowsKeyNotFoundException()
    {
        // Arrange
        var manager = CreateCharacterManager();
        var templates = new Dictionary<byte, CharacterTemplate>();
    ...
    [Test]
    public async Task GetExpands_ZeroStep_ThrowsKeyNotFoundException()
    {
        // Arrange
        var manager = CreateCharacterManager();
        var expandsDict = new Dictionary<int, List<Expand>>();
