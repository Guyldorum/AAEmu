...
public class WorldManagerTests
{
    ...
    [Test]
    public async Task GetWorldTemplateByName_NullName_ThrowsArgumentNullException()
    {
        // Arrange
        var manager = CreateWorldManager();
        var templates = new Dictionary<string, WorldTemplate>();
    ...
    [Test]
    public async Task RemoveWorld_NonExistingWorld_DoesNotThrow()
    {
        // Arrange
        var manager = CreateWorldManager();
        var worlds = new ConcurrentDictionary<uint, WorldInstance>();
    ...
    [Test]
    public async Task TryAddCharacter_NullCharacter_ThrowsNullReferenceException()
    {
        // Arrange
        var manager = CreateWorldManager();
